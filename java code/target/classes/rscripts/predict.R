...
exampledb_test <- dbConnect(sqlite_test,"/Users/paul2/Desktop/cs0320/term-project-as300-dthuku-jryoo-ptouma-sbelete/java code/predict.sqlite3")
dbListTables(exampledb_test)
query <- sprintf("SELECT * FROM main WHERE link = '%s'", link)
...
model_test <- readRDS("/Users/paul2/Desktop/cs0320/term-project-as300-dthuku-jryoo-ptouma-sbelete/java code/model.rds")
model_test
